...
def evaluate_homework(latex_text, rubric):
...
prompt="How correct is the solution, check it thoroughly, do not use latex code when you respond, just basic words."

path = "images/859421f1-0724-4d01-85c2-c02886432097.jpg"
preProcessing.preprocess_image(path)
latex_code=preProcessing.convert_to_TeX("Preprocessed_imgs/processed_text.png")
eval=evaluate_homework(latex_code, prompt)
print(eval)
